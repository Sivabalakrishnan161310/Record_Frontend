...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-visible min-h-screen">
        <header className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            <Button
              variant="outline"
              className="h-9 px-4 border-gray-200 hover:bg-gray-50 text-gray-700 font-medium text-sm"
            >
            ...
            <Button
              size="icon"
              variant="ghost"
              className="h-12 w-12 rounded-xl bg-orange-500 text-white hover:bg-white hover:text-black transition-colors">
              <Plus className="w-5 h-5  " strokeWidth={3.5} />
            </Button>

            <Button 
              size="icon" 
              className="h-12 w-12 rounded-xl border-0 bg-transparent hover:bg-white-100 text-gray-700 transition-all">
        ...
        <div className="p-8">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-start justify-between mb-6">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <h1 className="text-2xl font-bold text-gray-900">Basic Profile</h1>
              ...
              <div className="flex gap-3">
                <Button
                  variant="outline"
                  className="h-10 px-4 border-gray-200 hover:bg-gray-50 text-gray-700 font-medium"
                >
                  <Share2 className="w-4 h-4 mr-2" />
                  Profile Share
                </Button>
                <Button className="h-10 px-6 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-medium">
                  Save
                </Button>
              </div>
            </div>
            ...
            <div className="flex gap-8">
              <div className="w-64 space-y-6">
                <div className="flex flex-col items-center">
                  ...
                  <h2 className="text-xl font-bold text-gray-900">Thilak</h2>
                </div>
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="flex gap-2">
                        <Input
                          type="text"
                          value="+91"
                          className="w-20 h-12 bg-gray-50 border-gray-200 text-gray-700"
                        />
                        <Input
                          type="tel"
                          value="8667736358"
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex items-center gap-2 px-3 h-12 bg-gray-100 border border-gray-200 rounded-lg">
                            ...
                            <span className="text-sm text-gray-700">linkedin.com/</span>
                          </div>
                          <Input
                            type="text"
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex items-center gap-2 px-3 h-12 bg-gray-100 border border-gray-200 rounded-lg">
                            ...
                            <span className="text-sm text-gray-700">instagram.com/</span>
                          </div>
                          <Input
                            type="text"
                            className="flex-1 h-12 bg-white border-gray-200"
